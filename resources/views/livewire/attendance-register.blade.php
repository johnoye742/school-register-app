                    ...
                    <tbody class="divide-y divide-gray-500">
                        ...
                        <tr class="border-b">
                            ...
                            @if ($student -> status == "present")
                                <td class="px-6 py-4 text-red-500"><input type="checkbox" value="{{ $student -> id }}" placeholder="mark" wire:model="attend" wire:change="mark" checked disabled></td>
                            @endif

                            @if ($student -> status == "absent")
                            <td class="px-6 py-4 text-red-500"><input type="checkbox" value="{{ $student -> id }}" placeholder="mark" wire:model="attend" wire:change="mark" disabled></td>
                            @endif
